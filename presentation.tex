...
\centering\includegraphics[width=.94\textwidth,height=.72\textheight,keepaspectratio]{figures/wage_decomposition.pdf}
...
\centering\includegraphics[width=.94\textwidth,height=.69\textheight,keepaspectratio]{figures/adoption_share.pdf}
...
\begin{frame}{Checking the AI's headline}
\textbf{Claim to test:} ``Automation necessarily lowers wages and labor's share.''
\[
\frac{d\ln W}{dI}=g_I-D_I,\qquad
\frac{ds_L}{dI}=s_L(1-s_L)(1+\varepsilon_L)\frac{d\ln\omega}{dI}.
\]
\textbf{Verdict:} the wage claim is false in general. The share claim needs the static model's assumptions and a binding technology constraint. An inactive frontier has no marginal effect.
\par\medskip
\IfFileExists{hand/derivation.jpg}{\centering\includegraphics[height=.37\textheight]{hand/derivation.jpg}}{\color{rust}\small Handwritten evidence pending: insert the student's genuine derivation photo here. The typed equations are not a substitute for that requirement.}
\end{frame}
